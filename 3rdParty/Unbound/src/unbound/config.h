...
#define CHROOT_DIR "C:/Program Files (x86)/unbound/etc/unbound"

/* Do sha512 definitions in config.h */
/* #undef COMPAT_SHA512 */

/* Pathname to the Unbound configuration file */
#define CONFIGFILE "C:/Program Files (x86)/unbound/etc/unbound/unbound.conf"
...
#define CONFIGURE_TARGET "x86_64-windows"
...
#define PIDFILE "C:/Program Files (x86)/unbound/etc/unbound/unbound.pid"
...
#define RUN_DIR "C:/Program Files (x86)/unbound/etc/unbound"

/* Shared data */
#define SHARE_DIR "C:/Program Files (x86)/unbound/etc/unbound"

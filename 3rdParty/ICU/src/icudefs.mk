...
VERSION = 57.1
UNICODE_VERSION = 8.0
SO_TARGET_VERSION = 57.1
SO_TARGET_VERSION_MAJOR = 57
...
ICUDATA_BASENAME_VERSION = $(ICUPREFIX)dt57
# the entry point is almost like the basename, but has the lib suffix.  
ICUDATA_ENTRY_POINT = $(ICUPREFIX)dt57 
ICUDATA_CHAR = l
...
CPPFLAGS =  $(THREADSCPPFLAGS)  -DHAVE_DLOPEN=0 -DU_HAVE_ATOMIC=1 -DU_HAVE_MMAP=0 
...
include $(top_srcdir)/config/mh-mingw64

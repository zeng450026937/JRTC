#ifndef JXMPP_BOSHCONNECTION_H
#define JXMPP_BOSHCONNECTION_H
...
namespace JXMPP {
    ...
    class JXMPP_API BOSHError : public SessionStream::SessionStreamError {
        public:
            enum Type {
    ...
    class JXMPP_API BOSHConnection : public std::enable_shared_from_this<BOSHConnection> {
        public:

#ifndef JXMPP_BOSHCONNECTIONPOOL_H
#define JXMPP_BOSHCONNECTIONPOOL_H
...
namespace JXMPP {
    ...
    class JXMPP_API BOSHConnectionPool : public boost::signals2::trackable {
        public:
...
#endif // JXMPP_BOSHCONNECTIONPOOL_H

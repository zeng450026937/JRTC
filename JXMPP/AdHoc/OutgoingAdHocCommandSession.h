#ifndef JXMPP_OUTGOINGADHOCCOMMANDSESSION_H
#define JXMPP_OUTGOINGADHOCCOMMANDSESSION_H
...
namespace JXMPP {
    ...
    class JXMPP_API OutgoingAdHocCommandSession {
        public:
...
#endif // JXMPP_OUTGOINGADHOCCOMMANDSESSION_H

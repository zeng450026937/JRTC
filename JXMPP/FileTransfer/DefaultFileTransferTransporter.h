#ifndef JXMPP_DEFAULTFILETRANSFERTRANSPORTER_H
#define JXMPP_DEFAULTFILETRANSFERTRANSPORTER_H
...
namespace JXMPP {
    ...
    class JXMPP_API DefaultFileTransferTransporter : public FileTransferTransporter {
        public:
            enum Role {
                Initiator,
                Responder
...
#endif // JXMPP_DEFAULTFILETRANSFERTRANSPORTER_H

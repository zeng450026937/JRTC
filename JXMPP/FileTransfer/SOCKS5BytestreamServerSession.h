#ifndef JXMPP_SOCKS5BYTESTREAMSERVERSESSION_H
#define JXMPP_SOCKS5BYTESTREAMSERVERSESSION_H
...
namespace JXMPP {
    ...
    class JXMPP_API SOCKS5BytestreamServerSession {
        public:
...
#endif // JXMPP_SOCKS5BYTESTREAMSERVERSESSION_H

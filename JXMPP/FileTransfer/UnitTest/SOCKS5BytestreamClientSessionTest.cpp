...
private:
    ...
    void serverRespondRequestFail() {
        ...
        //JXMPP_LOG(debug) << "hexed: " << Hexify::hexify(failingData) << std::endl;
        do {
...
private:
    struct TestHelper {
        ...
        void handleConnectionDataWritten(const SafeByteArray& data) {
            ...
            //JXMPP_LOG(debug) << "unprocessedInput (" << unprocessedInput.size() <<  "): " << Hexify::hexify(unprocessedInput) << std::endl;
        }

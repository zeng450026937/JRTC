#ifndef JXMPP_CLIENTSESSION_H
#define JXMPP_CLIENTSESSION_H
...
namespace JXMPP {
    ...
    class JXMPP_API ClientSession : public std::enable_shared_from_this<ClientSession> {
        public:
            enum class State {
                Initial,
        ...
        private:
            ...
            std::shared_ptr<JXMPP::Error> error_;

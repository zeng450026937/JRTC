#define JXMPP_CACHE_JID_PREP

#include <sstream>
#include <string>
#include <vector>

#ifdef JXMPP_CACHE_JID_PREP
#include <mutex>
...
#ifndef JXMPP_JID_NO_DEFAULT_IDN_CONVERTER
#include <memory>
...
int JID::compare(const JXMPP::JID& o, CompareType compareType) const {

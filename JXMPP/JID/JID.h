...
namespace JXMPP {
    ...
    class JXMPP_API JID {
        public:
            ...
            bool operator<(const JXMPP::JID& b) const {
                return compare(b, JXMPP::JID::WithResource) < 0;
            }

            JXMPP_API friend std::ostream& operator<<(std::ostream& os, const JXMPP::JID& j);

            friend bool operator==(const JXMPP::JID& a, const JXMPP::JID& b) {
                return a.compare(b, JXMPP::JID::WithResource) == 0;
            }
            ...
            /**
             * If Swiften was compiled with JXMPP_JID_NO_DEFAULT_IDN_CONVERTER (not default), use this method at
    ...
    JXMPP_API std::ostream& operator<<(std::ostream& os, const JXMPP::JID& j);
}

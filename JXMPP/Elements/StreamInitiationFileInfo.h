#ifndef JXMPP_STREAMINITIATIONFILEINFO_H
#define JXMPP_STREAMINITIATIONFILEINFO_H
...
class JXMPP_API StreamInitiationFileInfo : public Payload {
public:
...
#endif // JXMPP_STREAMINITIATIONFILEINFO_H

#ifndef JXMPP_JINGLEFILETRANSFERFILEINFO_H
#define JXMPP_JINGLEFILETRANSFERFILEINFO_H
...
namespace JXMPP {
     ...
     */
    class JXMPP_API JingleFileTransferFileInfo : public Payload {
...
#endif // JXMPP_JINGLEFILETRANSFERFILEINFO_H

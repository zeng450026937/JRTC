#ifndef JXMPP_MIXUPDATESUBSCRIPTION_H
#define JXMPP_MIXUPDATESUBSCRIPTION_H
...
namespace JXMPP {
    class JXMPP_API MIXUpdateSubscription : public Payload {
...
#endif // JXMPP_MIXUPDATESUBSCRIPTION_H

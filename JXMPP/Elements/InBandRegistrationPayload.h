#ifndef JXMPP_INBANDREGISTRATIONPAYLOAD_H
#define JXMPP_INBANDREGISTRATIONPAYLOAD_H
...
namespace JXMPP {
    class JXMPP_API InBandRegistrationPayload : public Payload {
        public:
...
#endif // JXMPP_INBANDREGISTRATIONPAYLOAD_H

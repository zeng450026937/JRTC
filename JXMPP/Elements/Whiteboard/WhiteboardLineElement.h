#ifndef JXMPP_WHITEBOARDLINEELEMENT_H
#define JXMPP_WHITEBOARDLINEELEMENT_H
...
namespace JXMPP {
    class JXMPP_API WhiteboardLineElement : public WhiteboardElement {
    public:
...
#endif // JXMPP_WHITEBOARDLINEELEMENT_H

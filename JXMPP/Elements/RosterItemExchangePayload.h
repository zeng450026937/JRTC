#ifndef JXMPP_ROSTERITEMEXCHANGEPAYLOAD_H
#define JXMPP_ROSTERITEMEXCHANGEPAYLOAD_H
...
namespace JXMPP {
    class JXMPP_API RosterItemExchangePayload : public Payload {
        public:
            typedef std::shared_ptr<RosterItemExchangePayload> ref;

            class JXMPP_API Item {
                public:
...
#endif // JXMPP_ROSTERITEMEXCHANGEPAYLOAD_H

#ifndef JXMPP_WINDOWSAUTHENTICATION_H
#define JXMPP_WINDOWSAUTHENTICATION_H
...
namespace JXMPP {
     ...
     * Windows.
     */
    JXMPP_API std::shared_ptr<boost::system::error_code> getUserNameEx(std::string& userName, std::string& clientName, std::string& serverName);
     ...
     * Windows.
     */
    JXMPP_API std::shared_ptr<boost::system::error_code> acquireCredentialsHandle(PCredHandle credentialsHandle);
     ...
     * Windows.
     */
    JXMPP_API std::shared_ptr<boost::system::error_code> freeCredentialsHandle(PCredHandle credentialsHandle);
     ...
     * Windows.
     */
    JXMPP_API std::shared_ptr<boost::system::error_code> deleteSecurityContext(PCtxtHandle contextHandle);
     ...
     * Windows.
     */
    JXMPP_API std::shared_ptr<boost::system::error_code> completeAuthToken(const PCtxtHandle contextHandle, PSecBufferDesc token);
     ...
     * Windows.
     */
    JXMPP_API std::shared_ptr<boost::system::error_code> freeContextBuffer(PVOID contextBuffer);
     ...
     * Windows.
     */
    JXMPP_API std::shared_ptr<boost::system::error_code> decryptMessage(const PCtxtHandle contextHandle, const ByteArray& message, SafeByteArray& decrypted);
     ...
     * Windows.
     */
    JXMPP_API std::shared_ptr<boost::system::error_code> encryptMessage(const PCtxtHandle contextHandle, const SecPkgContext_Sizes& sizes, const SafeByteArray& message, SafeByteArray& output);
     ...
     * Windows.
     */
    JXMPP_API std::shared_ptr<boost::system::error_code> queryContextAttributes(const PCtxtHandle contextHandle, ULONG attribute, PVOID buffer);

}

#endif // JXMPP_WINDOWSAUTHENTICATION_H
